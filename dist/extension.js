...
const yamal_utils_1 = __webpack_require__(23);
const feature_utils_1 = __webpack_require__(24);
const importsManager_1 = __webpack_require__(29);
const mvvm_yamal_utils_1 = __webpack_require__(47);
const mvc_manager_1 = __webpack_require__(48);
function activate(context) {
    ...
    let mvcDisposable = vscode.commands.registerCommand("flutter-archichitecture.createMVCArchitecture", async () => {
        ...
        const rootPath = workspaceFolders[0].uri.fsPath;
        mvc_manager_1.MVCManager.createMVCStructure(rootPath);
    });
...
const custom_snackbar_1 = __webpack_require__(10);
const custom_snakbar_1 = __webpack_require__(11);
const shared_pref_helper_1 = __webpack_require__(12);
const validation_1 = __webpack_require__(13);
const custom_button_1 = __webpack_require__(14);
const custom_textfield_1 = __webpack_require__(15);
const error_route_1 = __webpack_require__(16);
const route_transition_1 = __webpack_require__(17);
const routes_1 = __webpack_require__(18);
const tab_bar_theme_1 = __webpack_require__(19);
const text_theme_1 = __webpack_require__(20);
const app_theme_1 = __webpack_require__(21);
const color_scheme_1 = __webpack_require__(22);
const yamal_utils_1 = __webpack_require__(23);
const feature_utils_1 = __webpack_require__(24);
const main_1 = __webpack_require__(28);
const feature_controller_1 = __webpack_require__(25);
const feature_state_1 = __webpack_require__(26);
const feature_repository_1 = __webpack_require__(27);
...
const app_url_1 = __webpack_require__(30);
const color_1 = __webpack_require__(31);
const internet_exception_widget_1 = __webpack_require__(32);
const loading_widget_1 = __webpack_require__(33);
const network_image_widget_1 = __webpack_require__(34);
const round_button_1 = __webpack_require__(35);
const extensions_1 = __webpack_require__(36);
const routes_1 = __webpack_require__(37);
const routes_name_1 = __webpack_require__(38);
const utils_1 = __webpack_require__(39);
const app_exceptions_1 = __webpack_require__(40);
const base_api_services_1 = __webpack_require__(41);
const network_api_services_1 = __webpack_require__(42);
const api_response_1 = __webpack_require__(43);
const status_1 = __webpack_require__(44);
const generated_plugin_registrant_1 = __webpack_require__(45);
const main_1 = __webpack_require__(46);
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MVCManager = void 0;
const vscode = __importStar(__webpack_require__(1));
const fs = __importStar(__webpack_require__(2));
const path = __importStar(__webpack_require__(3));
const mvc_yamal_utils_1 = __webpack_require__(49);
class MVCManager {
    static fileTemplates = {
        app_exceptions: `
...
class HomePage extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    static createMVCStructure(rootPath) {
        const directories = [
            "lib/controllers",
            "lib/models",
            "lib/views",
        ...
        mvc_yamal_utils_1.MVCYamalUtility.updateMVCPubspecYaml(rootPath);
        vscode.window.showInformationMessage("MVC Architecture created successfully!");
    }
}
exports.MVCManager = MVCManager;
...
Object.defineProperty(exports, "__esModule", ({ value: true }));
exports.MVCYamalUtility = void 0;
const vscode = __importStar(__webpack_require__(1));
const fs = __importStar(__webpack_require__(2));
const path = __importStar(__webpack_require__(3));
class MVCYamalUtility {
    static requiredPackages = {
        dio: "^5.4.0",
    };
    static updateMVCPubspecYaml(rootPath) {
        const pubspecPath = path.join(rootPath, "pubspec.yaml");
        if (fs.existsSync(pubspecPath)) {
            let pubspecContent = fs.readFileSync(pubspecPath, "utf-8");
            ...
            if (dependenciesMatch) {
                ...
                for (const [pkg, version] of Object.entries(MVCYamalUtility.requiredPackages)) {
                    if (!pubspecContent.includes(pkg + ":")) {
                        const flutterSdkMatch = pubspecContent.match(/sdk:\s*flutter\s*\n/);
                        if (flutterSdkMatch) {
                            const position = flutterSdkMatch.index + flutterSdkMatch[0].length;
                            pubspecContent =
                ...
                fs.writeFileSync(pubspecPath, pubspecContent);
                vscode.window.showInformationMessage("pubspec.yaml updated with MVC required packages.");
            }
            else {
                vscode.window.showErrorMessage("Could not find dependencies section in pubspec.yaml");
            }
        }
        else {
            vscode.window.showErrorMessage("pubspec.yaml not found.");
...
exports.MVCYamalUtility = MVCYamalUtility;
